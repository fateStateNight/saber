...
<div class="layuimini-container">
    <div class="layuimini-main">
        <table id="currentTable" class="layui-table layui-hide"
               data-auth-add="<?php echo auth('system.taobao_account/add'); ?>"
               data-auth-edit="<?php echo auth('system.taobao_account/edit'); ?>"
               data-auth-delete="<?php echo auth('system.taobao_account/delete'); ?>"
