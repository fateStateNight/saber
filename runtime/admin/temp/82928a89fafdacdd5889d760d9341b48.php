<?php /*a:2:{s:55:"/app/app/admin/view/business/order_statistic/index.html";i:1654762911;s:39:"/app/app/admin/view/layout/default.html";i:1602818599;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-tab-item layui-show">
            <div class="layui-col-xs6 layui-col-sm7 layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-header">统计首页</div>
                    <div class="layui-card-body">
                        <div class="layui-row">
                            <div id="everyday_order_num" style="width: 600px;height:400px;"></div>
                        </div>
