<?php /*a:2:{s:42:"/app/app/admin/view/system/admin/edit.html";i:1647849331;s:39:"/app/app/admin/view/layout/default.html";i:1678949704;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="nickname" class="layui-input" value="<?php echo htmlentities((isset($row['nickname']) && ($row['nickname'] !== '')?$row['nickname']:'')); ?>">
                <tip>填写昵称</tip>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="taobao_accountId" data-select="<?php echo url('system.taobaoAccount/index'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['taobao_accountId']) && ($row['taobao_accountId'] !== '')?$row['taobao_accountId']:'')); ?>" lay-search>
                </select>
            </div>
        </div>
