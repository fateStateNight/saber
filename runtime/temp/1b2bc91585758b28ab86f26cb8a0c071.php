<?php /*a:1:{s:30:"/app/view/company/index-3.html";i:1608628511;}*/ ?>
﻿<!DOCTYPE html>
...
<body>
    ...
    <div id="page" class="section">
        ...
        <div class="intro-section section" data-overlay="0.5" data-bg-image="/static/assets/images/hero-image/hero-4.jpg">
                    ...
                    <div class="col-12">
                        ...
                        <div class="video-popup-area">
                            ...
                            <div class="skill-video" data-aos="fade-up">
                                <img class="image" src="/static/assets/images/video/about-video.jpg" alt="video popup">
                ...
                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 g-0 mesonry-list">
                    ...
                    <div class="col cat-1 cat-3">
                        <div class="single-portfolio">
                            ...
                            <div class="content">
                                <h5 class="title"><a href="work-details.html">Project Name #1 <img src="/static/assets/images/icons/arrow-up-right.svg" alt=""></a></h5>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row row-cols-lg-4 row-cols-sm-2 row-cols-1 mb-n6">
                    ...
                    <div class="col mb-6">
                        ...
                        <div class="team">
                            <div class="thumb">
                                <img src="/static/assets/images/team/team-1.jpg" alt="team Images">
                    ...
                    <div class="col mb-6">
                        ...
                        <div class="team">
                            <div class="thumb">
                                <img src="/static/assets/images/team/team-2.jpg" alt="team Images">
                                <div class="overlay"></div>
                                <ul class="social-icon text-center">
                                    <li class="facebook"><a href="#" class="link" aria-label="Facebook"><i class="fab fa-facebook"></i></a></li>
                                    <li class="twitter"><a href="#" class="link" aria-label="Twitter"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col mb-6">
                        ...
                        <div class="team">
                            <div class="thumb">
                                <img src="/static/assets/images/team/team-3.jpg" alt="team Images">
                                <div class="overlay"></div>
                                <ul class="social-icon text-center">
                                    <li class="facebook"><a href="#" class="link" aria-label="Facebook"><i class="fab fa-facebook"></i></a></li>
                                    <li class="twitter"><a href="#" class="link" aria-label="Twitter"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col mb-6">
                        ...
                        <div class="team">
                            <div class="thumb">
                                <img src="/static/assets/images/team/team-4.jpg" alt="team Images">
                                <div class="overlay"></div>
                                <ul class="social-icon text-center">
                                    <li class="facebook"><a href="#" class="link" aria-label="Facebook"><i class="fab fa-facebook"></i></a></li>
                                    <li class="twitter"><a href="#" class="link" aria-label="Twitter"><i class="fab fa-twitter"></i></a></li>
        ...
        <div class="section section-padding-t90-b100" data-bg-color="#f8faff">
            <div class="container shape-animate">
                ...
                <!-- Animation Shape Start -->
                <div class="shape shape-1 scene">
                    <span data-depth="4"><img src="/static/assets/images/shape-animation/video-shape-1.png" alt="shape"></span>
                </div>
                <!-- Animation Shape End -->
        ...
        <div class="footer-section section" data-bg-color="#030e22">
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <p class="copyright">Copyright &copy; 2020 <a href="http://www.bootstrapmb.com">HasThemes</a>. All Rights Reserved.</p>
                    </div>
                </div>
